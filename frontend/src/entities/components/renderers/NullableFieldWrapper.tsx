...
// no awareness of what that control actually is. Null state shows a plain "null
// (click to set)" placeholder that hands off to the normal edit flow; non-null state
// renders the concrete control plus a small clear (x) button next to it.
